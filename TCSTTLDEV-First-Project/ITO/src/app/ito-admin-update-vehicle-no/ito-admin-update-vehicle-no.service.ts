...
@Injectable()
export class ItoUpdateVehicleService {
    //URL to get the Details from DB 
    private _getVehicleCache: string = "http://10.0.0.4:8082/ITO/update/getTransportUpdatedPriceListDomestic";
    ...
    private _updatevehicleTransport:string="http://10.0.0.4:8082/ITO/update/updatePriceTransportDomestic";
