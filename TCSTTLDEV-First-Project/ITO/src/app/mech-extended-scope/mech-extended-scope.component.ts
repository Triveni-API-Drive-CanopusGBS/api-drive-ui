...
import { MechExtendedScopeService } from './mech-extended-scope.service';
import { dboClass } from './mech-extended-scope';
...
@Component({
  selector: 'app-mech-extended-scope',
  templateUrl: './mech-extended-scope.component.html',
  styleUrls: ['./mech-extended-scope.component.css']
})
export class MechExtendedScopeComponent implements OnInit {
 ...
 // ArrayOfSelected: Array<turbineConfigValues>;
  ...
  dboMechanicalScopeLocal: Array<any> = [];
  ...
  constructor(private _MechExtendedScopeService: MechExtendedScopeService, private _ITOLoginService: ITOLoginService,
    ...
    private _ITOCostEstimationService: ITOCostEstimationService, private router: Router) {
      ...
      if (this.storage.get(this.MechExpScope) == null) {
        this.saveInLocal(this.MechExpScope, { 
...
console.log(this._ITOeditQoutService.mechExtScpList);
      if(this._ITOeditQoutService.mechExtScpList!=null && this._ITOeditQoutService.mechExtScpList.length!=0){
        this.mainSave=false;
        this.mainSave2=false;
        this.mainSave3=false;
        console.log(this._ITOeditQoutService.mechExtScpList);
        if(this._ITOeditQoutService.mechExtScpList[0].mechComrComments != "" && this._ITOeditQoutService.mechExtScpList[0].mechComrComments != null){
          this.itemCmrRemarksVal = this._ITOeditQoutService.mechExtScpList[0].mechComrComments;
          this.othItmComrRemChk=true;
          this.itemComrRemarkCheck=true;
          this.itemComrRemarkDiv=true;
        }
        if(this._ITOeditQoutService.mechExtScpList[0].mechTechComments != "" && this._ITOeditQoutService.mechExtScpList[0].mechTechComments != null){
          this.itemRemarksVal = this._ITOeditQoutService.mechExtScpList[0].mechTechComments;
          this.othItmTechRemChk=true;
          this.itemtechRemarkCheck=true;
          this.itemRemarkDiv=true;
        }
        if(this._ITOeditQoutService.mechExtScpList[0].mechTotalExtCost != 0){
          this.totalPrice = this._ITOeditQoutService.mechExtScpList[0].mechTotalExtCost;
        }
        ...
        for(let c=0;c<this._ITOeditQoutService.mechExtScpList.length;c++)
        {
          ...
          this.dboClass.itemName = this._ITOeditQoutService.mechExtScpList[c].itemName;
          this.dboClass.subItemId = this._ITOeditQoutService.mechExtScpList[c].subItemId;
          this.dboClass.subItemName = this._ITOeditQoutService.mechExtScpList[c].subItemName;
          this.dboClass.colId = 0;
          this.dboClass.colNm = this._ITOeditQoutService.mechExtScpList[c].colNm;
          this.dboClass.colValCd = this._ITOeditQoutService.mechExtScpList[c].colValCd;
          this.dboClass.quantity = this._ITOeditQoutService.mechExtScpList[c].quantity;
          this.dboClass.cost = this._ITOeditQoutService.mechExtScpList[c].extScopeCost;
          this.dboClass.techRemarks = this._ITOeditQoutService.mechExtScpList[c].techRemarks;
          this.dboClass.comrRemarks = this._ITOeditQoutService.mechExtScpList[c].comrRemarks;
      ...
      //  this.itemOthersAddonList =  this._ITOeditQoutService.mechExtScpList.reduce((acc, current) => {
      //   console.log(acc, current);
      //   const x = acc.find(item => item.itemName === current.itemName);
      //   if (!x) {
      //     return acc.concat([current]);
      ...
      {
        if(this.storage.get(this.MechExpScope) != null){
        if(this.storage.get(this.MechExpScope).itemOthersAddonList.length !=0){
          this.othersCheck = true;
          this.addOns=true;
  
          this.othersItemCompCheck=true;
          this.displayItemCompOthTable = true;
          this.itemOthersAddonList = this.storage.get(this.MechExpScope).itemOthersAddonList;
          this.mainSave=false;
          this.mainSave2=false;
          this.mainSave3=false;
        }
        ...
        if(this.storage.get(this.MechExpScope).lhsRhsItemsList.length!= 0){
          this.lhsRhsItemsList = this.storage.get(this.MechExpScope).lhsRhsItemsList;
        }

        if(this.storage.get(this.MechExpScope).itemCmrRemarksVal != null && this.storage.get(this.MechExpScope).itemCmrRemarksVal != ""){
          this.itemCmrRemarksVal = this.storage.get(this.MechExpScope).itemCmrRemarksVal;
          this.othItmComrRemChk=true;
          this.itemComrRemarkCheck=true;
          this.itemComrRemarkDiv=true;
        }
        if(this.storage.get(this.MechExpScope).itemRemarksVal != null && this.storage.get(this.MechExpScope).itemRemarksVal != ""){
          this.itemRemarksVal = this.storage.get(this.MechExpScope).itemRemarksVal;
          this.othItmTechRemChk=true;
          this.itemtechRemarkCheck=true;
          this.itemRemarkDiv=true;
        }
        if(this.storage.get(this.MechExpScope).totalPrice != 0){
          this.totalPrice = this.storage.get(this.MechExpScope).totalPrice;
        }
      }
      }
    }
...
checkItemComrRmrks(){
  ...
  console.log(this.itemCmrRemarksVal);
    ...
    saveInLocal(key, val): void {
      ...
      this.dboMechanicalScopeLocal[key] = this.storage.get(key);
    }
    addRowsItem() {
      this.mainSave=true;
      this.mainSave2=true;
  ...
  calcTotal()
  {
    ...
    this.dboFormData.mechExtScopeTechComments =this.itemRemarksVal; 
    this.dboFormData.mechExtScopeComrComments = this.itemCmrRemarksVal;
    this.dboFormData.modifiedById = this._ITOLoginService.loggedUserDetails;
    this.dboFormData.quotId = this._ITOcustomerRequirementService.saveBasicDet.quotId;
    this.dboFormData.mechExtScopeData = this.lhsRhsItemsList;
    this._MechExtendedScopeService.saveExtendedMech(this.dboFormData).subscribe(savedResp => {
      this.mainSave2=false;
