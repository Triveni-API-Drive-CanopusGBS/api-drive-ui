...
@Component({
  selector: 'app-control-instrumentation',
  templateUrl: './control-instrumentation.component.html',
  styleUrls: ['./control-instrumentation.component.css']
})
export class ControlInstrumentationComponent implements OnInit {
  ...
  totalF2FCost: any = 0;
  turbineInstrumentCost: number = 0;
