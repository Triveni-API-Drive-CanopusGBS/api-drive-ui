...
@Component({
  selector: 'app-performance-admin-other',
  templateUrl: './performance-admin-other.component.html',
  styleUrls: ['./performance-admin-other.component.css']
})
export class PerformanceAdminOtherComponent implements OnInit {
...
update()
{
  ...
  this.dboClass.activeNew=1;//not there
  ...
  this.adminForm.adminPerfOtherList.push(this.dboClass);
  }
  this._BgmratingsComponentService.getAdminPerfOther(this.adminForm).subscribe(res => {
    console.log(res);
    this.adminForm = res;
