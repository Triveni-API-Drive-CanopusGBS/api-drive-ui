...
import {dboEleCiExtdScopeService} from './dbo-ele-ciextd-scope.service';

@Component({
  selector: 'app-dbo-ele-ciextd-scope',
  templateUrl: './dbo-ele-ciextd-scope.component.html',
  styleUrls: ['./dbo-ele-ciextd-scope.component.css']
})
export class DboEleCiextdScopeComponent implements OnInit {
 ...
 // ArrayOfSelected: Array<turbineConfigValues>;
  ...
  constructor(private _dboEleCiExtdScopeService: dboEleCiExtdScopeService, private _ITOLoginService: ITOLoginService,
    ...
    private _ITOCostEstimationService: ITOCostEstimationService, private router: Router) {
      ...
      if (this.storage.get(this.EleCiExtdScope) == null) {
        this.saveInLocal(this.EleCiExtdScope, { 
...
console.log(this._ITOeditQoutService.eleCIExtScopeList);
      if(this._ITOeditQoutService.eleCIExtScopeList!=null && this._ITOeditQoutService.eleCIExtScopeList.length!=0){
        this.mainSave=false;
      this.mainSave2=false;
      this.mainSave3=false;
        console.log(this._ITOeditQoutService.eleCIExtScopeList);

        if(this._ITOeditQoutService.eleCIExtScopeList[0].cIComrComments != "" && this._ITOeditQoutService.eleCIExtScopeList[0].cIComrComments != null){
          this.itemCmrRemarksVal = this._ITOeditQoutService.eleCIExtScopeList[0].cIComrComments;
        ...
        if(this._ITOeditQoutService.eleCIExtScopeList[0].cITechComments != "" && this._ITOeditQoutService.eleCIExtScopeList[0].cITechComments != null){
          this.itemRemarksVal = this._ITOeditQoutService.eleCIExtScopeList[0].cITechComments;
        ...
        if(this._ITOeditQoutService.eleCIExtScopeList[0].cITotalExtCost != 0){
          this.totalPrice = this._ITOeditQoutService.eleCIExtScopeList[0].cITotalExtCost;
        }
        ...
        for(let c=0;c<this._ITOeditQoutService.eleCIExtScopeList.length;c++)
        {
          ...
          this.dboClass.itemName = this._ITOeditQoutService.eleCIExtScopeList[c].itemName;
          this.dboClass.subItemId = this._ITOeditQoutService.eleCIExtScopeList[c].subItemId;
          this.dboClass.subItemName = this._ITOeditQoutService.eleCIExtScopeList[c].subItemName;
          this.dboClass.colId = 0;
          this.dboClass.colNm = this._ITOeditQoutService.eleCIExtScopeList[c].colNm;
          this.dboClass.colValCd = this._ITOeditQoutService.eleCIExtScopeList[c].colValCd;
          this.dboClass.quantity = this._ITOeditQoutService.eleCIExtScopeList[c].quantity;
          this.dboClass.cost = this._ITOeditQoutService.eleCIExtScopeList[c].extScopeCost;
          this.dboClass.techRemarks = this._ITOeditQoutService.eleCIExtScopeList[c].techRemarks;
          this.dboClass.comrRemarks = this._ITOeditQoutService.eleCIExtScopeList[c].comrRemarks;
      ...
      //  this.itemOthersAddonList =  this._ITOeditQoutService.eleCIExtScopeList.reduce((acc, current) => {
      //   console.log(acc, current);
      //   const x = acc.find(item => item.itemName === current.itemName);
      //   if (!x) {
      //     return acc.concat([current]);
      ...
      {
        if(this.storage.get(this.EleCiExtdScope).itemOthersAddonList.length !=0){
          this.othersCheck = true;
          this.addOns=true;
  
          this.othersItemCompCheck=true;
          this.displayItemCompOthTable = true;
          this.itemOthersAddonList = this.storage.get(this.EleCiExtdScope).itemOthersAddonList;
          this.mainSave=false;
          this.mainSave2=false;
          this.mainSave3=false;
        ...
        if(this.storage.get(this.EleCiExtdScope).itemCmrRemarksVal != null && this.storage.get(this.EleCiExtdScope).itemCmrRemarksVal != ""){
          this.itemCmrRemarksVal = this.storage.get(this.EleCiExtdScope).itemCmrRemarksVal;
          this.othItmComrRemChk=true;
          this.itemComrRemarkCheck=true;
          this.itemComrRemarkDiv=true;
        }
        if(this.storage.get(this.EleCiExtdScope).itemRemarksVal != null && this.storage.get(this.EleCiExtdScope).itemRemarksVal != ""){
          this.itemRemarksVal = this.storage.get(this.EleCiExtdScope).itemRemarksVal;
          this.othItmTechRemChk=true;
          this.itemtechRemarkCheck=true;
          this.itemRemarkDiv=true;
        }

        if(this.storage.get(this.EleCiExtdScope).totalPrice != 0){
          this.totalPrice = this.storage.get(this.EleCiExtdScope).totalPrice;
        }
    
        // to dispaly new item creation other with lhs/rhs from local storage
        if(this.storage.get(this.EleCiExtdScope).lhsRhsItemsList.length!= 0){
          this.lhsRhsItemsList = this.storage.get(this.EleCiExtdScope).lhsRhsItemsList;
        }
      }
    }
...
checkItemComrRmrks(){
  ...
  console.log(this.itemCmrRemarksVal);
    ...
    saveInLocal(key, val): void {
      ...
      this.dboCIExtScopeLocal[key] = this.storage.get(key);
    }
    addRowsItem() {
      this.mainSave=true;
      this.mainSave2=true;
  ...
  calcTotal()
  {
    ...
    if(this.getPrice )
    {
    this.dboFormData.cIExtScopeTechComments = this.itemRemarksVal; 
    this.dboFormData.cIExtScopeComrComments = this.itemCmrRemarksVal;
    this.dboFormData.modifiedById = this._ITOLoginService.loggedUserDetails;
    this.dboFormData.quotId = this._ITOcustomerRequirementService.saveBasicDet.quotId;
    this.dboFormData.cIExtScopeData = this.lhsRhsItemsList;
    console.log(this.dboFormData);
    this._dboEleCiExtdScopeService.saveExtendedEleCi(this.dboFormData).subscribe(savedResp => {
      this.mainSave2=false;
