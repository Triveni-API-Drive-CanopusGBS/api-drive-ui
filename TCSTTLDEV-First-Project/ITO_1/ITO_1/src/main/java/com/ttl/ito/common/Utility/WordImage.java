...
//	private static final String IMAGE2 = "C:\\Users\\Public\\Pictures\\Sample Pictures\\TABLE.png";
//
...
//
//		run = paragraph.createRun();
//		run.addPicture(new FileInputStream(IMAGE2), Document.PICTURE_TYPE_PNG, "table", Units.toEMU(250), Units.toEMU(250));
//
//		paragraph = doc.createParagraph();
//		run = paragraph.createRun();
//		run.addBreak(BreakType.PAGE);
...
//
//		doc.write(new FileOutputStream("D:\\megha\\wordwithimage1.docx"));
